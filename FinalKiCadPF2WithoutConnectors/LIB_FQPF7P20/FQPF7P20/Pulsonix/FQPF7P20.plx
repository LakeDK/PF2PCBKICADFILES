...
//1705684/1393210/2.50/3/3/MOSFET P-Channel
...
(library Library_1
	...
	(patternDef "TO254P274X1016X1970-3P" (originalName "TO254P274X1016X1970-3P")
		(multiLayer
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 7.97 3.51) (pt 7.97 -1.21) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 7.97 -1.21) (pt -2.89 -1.21) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -2.89 -1.21) (pt -2.89 3.51) (width 0.05))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.64 3.26) (pt 7.72 3.26) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.72 3.26) (pt 7.72 0.52) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.72 0.52) (pt -2.64 0.52) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.64 0.52) (pt -2.64 3.26) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.64 1.99) (pt -1.37 3.26) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 7.72 0.52) (pt 7.72 3.26) (width 0.2))
		)
		(layerContents (layerNumRef 18)
	...
	(symbolDef "FQPF7P20" (originalName "FQPF7P20")
	...
	(compDef "FQPF7P20" (originalName "FQPF7P20") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "FQPF7P20"))
		(attachedPattern (patternNum 1) (patternName "TO254P274X1016X1970-3P")
			(numPads 3)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "FQPF7P20")
		(attr "Description" "P-Channel MOSFET, 5.2 A, 200 V, 3-Pin TO-220F ON Semiconductor FQPF7P20")
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/FQPF7P20-D.pdf")
		(attr "<Component Height>" "2.74")
		(attr "<STEP Filename>" "FQPF7P20.stp")
