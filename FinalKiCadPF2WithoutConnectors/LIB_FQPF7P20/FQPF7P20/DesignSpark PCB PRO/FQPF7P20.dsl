...
(library Library_1
	...
	(patternDef "TO254P274X1016X1970-3P" (originalName "TO254P274X1016X1970-3P")
		...
		(layerContents (layerNumRef 28)
			(line (pt 7.72 3.26) (pt 7.72 0.52) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.72 0.52) (pt -2.64 0.52) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.64 0.52) (pt -2.64 3.26) (width 0.1))
		)
		(layerContents (layerNumRef 28)
	...
	(compDef "FQPF7P20" (originalName "FQPF7P20") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "Datasheet Link" "https://www.onsemi.com/pub/Collateral/FQPF7P20-D.pdf")
		(attr "Height" "2.74 mm")
	)
